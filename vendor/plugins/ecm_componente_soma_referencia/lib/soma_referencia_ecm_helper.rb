...
#-------------------------------------------------------------------------------
  ...
  def soma_referencia_ecm_form_item_ajax(form_item, params, valor=nil)
    view = "<table>"
    view.concat("<tr><td class='lista_item'/><td class='lista_conteudo'><h4>Filtrar pelos Itens</h4></td></tr>")
    unless valor
    ...
    if campos_soma.size > 0
      ...
      view.concat("<tr>")
       view.concat("<td class='lista_item'>")
       view.concat("<td class='lista_conteudo'><h4>Lista de Campos Somáveis</h4></td>")
      view.concat("</tr>")
      view.concat("<tr>")
       view.concat("<td class='lista_item'>")
